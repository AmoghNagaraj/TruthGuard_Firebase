...
const NarrativeAnalysisOutputSchema = z.object({
  ...
  counterPoints: z.array(z.string()).describe(
    'A prioritized list of counter-arguments or fact-based points to mitigate the narrative.'
  ),
...
const narrativeAnalysisPrompt = ai.definePrompt({
  ...
  **Your analysis must include:**
  ...
  5.  **counterPoints**: A clear, ordered list of fact-based points to counter the narrative.
